...
URLDownloadToFile, https://raw.githubusercontent.com/SpArX0110/Custom-Quick-Chat-RL/main/Custom_Quick_Chat_XB.ahk, update.txt
...
FileDelete, update.txt
FileDelete, Custom_Quick_Chat_XB.exe
FileAppend,
(
...
Dropdownlist0 := ["A","B","X","Y","LB","RB","Select","Pause","L3","R3","🠉","🠊","🠋","🠈"]
Loop, % Dropdownlist0.MaxIndex()
	DDLString0 .= Dropdownlist0[A_Index]"|"
Gui, Add, DropDownList,xm+15 gcheck_choices vMyDLL0 choose7,%DDLString0%
Gui, Add, Text,xm+13 c%textcolor% vQuickchat6, (Select recommended)
...
Dropdownlist := ["","A","B","X","Y","LB","RB","Select","Pause","L3","R3","🠉","🠊","🠋","🠈"]
...
while i <= number_buttons
{
Gui, Add, DropDownList,w80 vMyDLL%i% hwndDDL_ID%i%, %DDLString% ;["A","B","X","Y","LB","RB","Select","Pause","L3","R3","🠉","🠊","🠋","🠈"]
i++
}
...
Else If(MyDLL0 = "RB")
	Button0 = Joy6
Else If(MyDLL0 = "Select")
	Button0 = Joy7
Else If(MyDLL0 = "Pause")
	Button0 = Joy8
Else If(MyDLL0 = "L3")
	Button0 = Joy9
Else If(MyDLL0 = "R3")
...
;["A","B","X","Y","LB","RB","Select","Pause","L3","R3","🠉","🠊","🠋","🠈"]
...
Else If(MyDLL%i% = "RB")
	Button%i% = Joy6
Else If(MyDLL%i% = "Select")
	Button%i% = Joy7
Else If(MyDLL%i% = "Pause")
	Button%i% = Joy8
Else If(MyDLL%i% = "L3")
	Button%i% = Joy9
Else If(MyDLL%i% = "R3")
...
{
   Dropdownlist[a] = "A" ? Dropdownlist.RemoveAt(a) : ++a
...
while a <= Dropdownlist.MaxIndex()	
{
   Dropdownlist[a] = "B" ? Dropdownlist.RemoveAt(a) : ++a
   DDLString1 .= "|"Dropdownlist[A_Index]
...
while a <= Dropdownlist.MaxIndex()	
{
   Dropdownlist[a] = "Y" ? Dropdownlist.RemoveAt(a) : ++a
   DDLString1 .= "|"Dropdownlist[A_Index]
...
while a <= Dropdownlist.MaxIndex()	
{
   Dropdownlist[a] = "LB" ? Dropdownlist.RemoveAt(a) : ++a
   DDLString1 .= "|"Dropdownlist[A_Index]
...
while a <= Dropdownlist.MaxIndex()	
{
   Dropdownlist[a] = "RB" ? Dropdownlist.RemoveAt(a) : ++a
   DDLString1 .= "|"Dropdownlist[A_Index]
...
while a <= Dropdownlist.MaxIndex()	
{
   Dropdownlist[a] = "Select" ? Dropdownlist.RemoveAt(a) : ++a
   DDLString1 .= "|"Dropdownlist[A_Index]
...
while a <= Dropdownlist.MaxIndex()	
{
   Dropdownlist[a] = "Pause" ? Dropdownlist.RemoveAt(a) : ++a
   DDLString1 .= "|"Dropdownlist[A_Index]
